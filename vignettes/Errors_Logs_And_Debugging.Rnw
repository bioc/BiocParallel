...
<<errors_6tasksA_stopOnError, eval=FALSE>>=
X <- list(1, 2, "3", 4, 5, 6)
...
<<errors_6tasksB_stopOnError, eval=FALSE>>=
...
<<errors_3tasksA_stopOnError, eval=FALSE>>=
X <- list(1, 2, "3", 4, 5, 6)
...
<<errors_3tasks_fun_stopOnError, eval=FALSE>>=
...
<<errors_3tasksB_stopOnError, eval=FALSE>>=
...
<<errors_bpok_bplapply, eval=FALSE>>=
...
<<errors_BPREDO_input, eval=FALSE>>=
X.redo <- list(1, 2, 3)
@
...
<<errors_BPREDO_recall, eval=FALSE>>=
...
<<timeout_constructor, eval=FALSE>>=
...
<<debug_sqrt_wrap, eval=FALSE>>=
fun3 <- function(i) sqrt(i)
@

Debug the new function:

<<debug_sqrt_debug, eval=FALSE>>=
debug(fun3)
@
